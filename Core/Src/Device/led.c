...
static GPIO_info_t LED_ioTable[] = {
	[LED_ID_1] = {GPIOA, { GPIO_PIN_9, GPIO_MODE_OUTPUT_PP, GPIO_PULLDOWN, GPIO_SPEED_FREQ_LOW}},
	[LED_ID_2] = {GPIOA, { GPIO_PIN_10, GPIO_MODE_OUTPUT_PP, GPIO_PULLDOWN, GPIO_SPEED_FREQ_LOW}},
	[LED_ID_3] = {GPIOB, { GPIO_PIN_10, GPIO_MODE_OUTPUT_PP, GPIO_PULLDOWN, GPIO_SPEED_FREQ_LOW}}
};
