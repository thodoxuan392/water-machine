...
typedef enum {
	...
	PROTOCOL_ID_COMMAND_PLAY_AUDIO = 0x44,
	PROTOCOL_ID_COMMAND_PLAY_AUDIO_ACK = 0x45,
	PROTOCOL_ID_COMMAND_PLAY_AUDIO_RESULT = 0x46,

	PROTOCOL_ID_COMMAND_UPDATE_RFID = 0x47,
	PROTOCOL_ID_COMMAND_UPDATE_RFID_ACK = 0x48,
	PROTOCOL_ID_COMMAND_UPDATE_RFID_RESULT = 0x49,
